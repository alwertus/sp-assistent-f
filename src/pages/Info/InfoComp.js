...
import {createSpace, getSpaces} from "./InfoActions";
...
export const InfoComp = () => {
    ...
    // const text = <ol>{Array(200).fill(<li key={Math.round(Math.random()*100000000+Math.random()*10000000)}>zzzggggggggg</li>)}</ol>
    const text = "11"

...
import listOl from "./img/list-ol.svg"
import listUl from "./img/list-ul.svg"
import typeNormal from "./img/type.svg"
import typeH1 from "./img/type-h1.svg"
import typeH2 from "./img/type-h2.svg"
import typeH3 from "./img/type-h3.svg"
...
export const ICONS = {
    ...
    listOl: <img className={style.image} src={listOl} alt={"alt"}/>,
    listUl: <img className={style.image} src={listUl} alt={"alt"}/>,
    typeNormal: <img className={style.image} src={typeNormal} alt={"alt"}/>,
    typeH1: <img className={style.image} src={typeH1} alt={"alt"}/>,
    typeH2: <img className={style.image} src={typeH2} alt={"alt"}/>,
    typeH3: <img className={style.image} src={typeH3} alt={"alt"}/>,
